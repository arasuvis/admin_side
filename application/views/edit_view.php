...
<!-- general form elements -->
              <div class="box box-primary col-lg-1 col-md-1">
                ...
                <!-- form start -->
               <form method="POST" action="<?php echo base_url('/index.php/edit/input');?>">
			   <input type="hidden" name="id" value="<?php echo $entry->id; ?>"/>
                  <div class="box-body">
					...
					<div class="form-group">
                      ...
                      <input type="phone_number" class="form-control" value="<?php echo $entry->phone_number; ?>" id="phone_number" name="phone_number" placeholder="Password">
                    </div>
					<div class="form-group">
